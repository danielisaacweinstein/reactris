...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {

	"use strict";

	/* REACT HOT LOADER */if (false) {
	  (function () {
	    var ReactHotAPI = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-api/modules/index.js"),
	        RootInstanceProvider = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/RootInstanceProvider.js"),
	  ...
	  (function () {
	    ...
	    var _Tetris = __webpack_require__(186);
	    ...
	    _reactDom2.default.render(_react2.default.createElement(_reactRedux.Provider, { store: store }, _react2.default.createElement(_Tetris.TetrisContainer, null)), document.getElementById('react'));
	  ...
	  if (false) {
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */if (false) {
	  ...
	  (function () {
	    ...
	    var _collisionLogic = __webpack_require__(164);

	    var _gameflowLogic = __webpack_require__(165);
	    ...
	    function setInitialState(state, incomingData) {
	      var width = incomingData.dimensions[0];
	      var height = incomingData.dimensions[1];
	      var size = incomingData.blockSize;
	    ...
	    function descend(state, incomingData) {
	      var isHittingBottom = (0, _collisionLogic.getCollisionDetector)(state, [0, 1], [0, 0]);
	      var isPaused = state.get('isPaused');
	      var gameLost = state.get('gameLost');

	      if (!isHittingBottom() && !isPaused && !gameLost) {
	        state = state.update('livePiece', function (blocks) {
	          return blocks.map(function (block) {
	            return block.update('y', function (yValue) {
	              return yValue + 20;
	            });
	          });
	        });
	      } else if (isHittingBottom() && !isPaused && !gameLost) {
	        state = (0, _gameflowLogic.lockLivePiece)(state);
	        state = (0, _gameflowLogic.makeQueuedPieceLive)(state);
	        state = (0, _gameflowLogic.queueNewPiece)(state);
	        if ((0, _collisionLogic.doesOverlap)(state, state.get('livePiece'))) {
	          state = state.update('gameLost', function () {
	            return true;
	          });
	        }
	      }

	      return (0, _gameflowLogic.attemptCollapse)(state);
	    }

	    function moveHorizontal(state, incomingData) {
	      var blockSize = state.getIn(['gameSpec', 'blockSize']);
	      var gameLost = state.get('gameLost');
	      var xShift = incomingData.shift;
	      var isLeft = xShift === -1;

	      var _ref = isLeft ? [[0, 0], [1, 0]] : [[1, 0], [0, 0]];

	      var _ref2 = _slicedToArray(_ref, 2);

	      var liveIndex = _ref2[0];
	      var deadIndex = _ref2[1];

	      var isHittingSide = (0, _collisionLogic.getCollisionDetector)(state, liveIndex, deadIndex);
	      var isPaused = state.get('isPaused');

	      if (!isHittingSide() && !isPaused && !gameLost) {
	        state = state.update('livePiece', function (blocks) {
	          return blocks.map(function (block) {
	            return block.update('x', function (xValue) {
	              return xValue + xShift * blockSize;
	            });
	          });
	        });
	      }
	    ...
	    function getRotatedSquare(pivotSquare, rotatingSquare) {
	      var xDelta = rotatingSquare.get('x') - pivotSquare.get('x');
	      var yDelta = rotatingSquare.get('y') - pivotSquare.get('y');

	      var matrix = [[0, 1], [-1, 0]]; // Rotation matrix

	      var newVector = [matrix[0][0] * xDelta + matrix[0][1] * yDelta, matrix[1][0] * xDelta + matrix[1][1] * yDelta];

	      rotatingSquare = rotatingSquare.update('x', function () {
	        return pivotSquare.get('x') + newVector[0];
	      });

	      rotatingSquare = rotatingSquare.update('y', function () {
	    ...
	    function rotate(state, incomingData) {
	      var piece = state.get('livePiece');
	      var isPaused = state.get('isPaused');
	      var gameLost = state.get('gameLost');

	      if (!isPaused && !gameLost) {
	        (function () {
	          var pivotSquare = piece.reduce(function (alreadyFoundPivot, square) {
	            var squareIsPivot = square.get('isPivot') == true;
	            return squareIsPivot ? square : alreadyFoundPivot || false;
	          }, false);

	          var rotatedPiece = piece.map(function (square) {
	            var isPivot = square.get('isPivot') == true;
	            return isPivot ? square : getRotatedSquare(pivotSquare, square);
	          });

	          if (!(0, _collisionLogic.doesOverlap)(state, rotatedPiece)) {
	            state = state.update('livePiece', function () {
	              return rotatedPiece;
	            });
	          }
	        })();
	    ...
	    function incrementTime(state, incomingData) {
	      return state.update('secondsElapsed', function (alreadyElapsed) {
	        return alreadyElapsed + 1;
	      });
	    }

	    function pause(state, incomingData) {
	      return state.update('isPaused', function () {
	        return true;
	      });
	    }
	    ...
	    function play(state, incomingData) {
	      if (state.get('livePiece').size === 0) {
	        state = (0, _gameflowLogic.createLivePiece)(state);
	        state = (0, _gameflowLogic.queueNewPiece)(state);
	      }
	    ...
	    function reducer() {
	      var state = arguments.length <= 0 || arguments[0] === undefined ? Immutable.Map() : arguments[0];
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot not apply hot update to " + "reducer.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */if (false) {
	  ...
	  (function () {
	    ...
	    function getColor() {
	      var colors = ["#2e86ab", "#a23b72", "#f18f01", "#c73e1d", "#3b1f2b"];
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot not apply hot update to " + "helpers.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */if (false) {
	  ...
	  (function () {
	    ...
	    exports.getCollisionDetector = getCollisionDetector;
	    ...
	    function getBoundaries(boundaryPieces, gameSpec) {
	      ...
	      for (var i = 0; i < widthRatio; i++) {
	        boundaryPieces = boundaryPieces.push(Immutable.fromJS({ x: i * blockSize, y: heightRatio * blockSize }));
	      }

	      for (var i = 0; i < heightRatio; i++) {
	        boundaryPieces = boundaryPieces.push(Immutable.fromJS({ x: widthRatio * blockSize, y: i * blockSize }));
	      }

	      for (var i = 0; i < heightRatio; i++) {
	        boundaryPieces = boundaryPieces.push(Immutable.fromJS({ x: 0 - blockSize, y: i * blockSize }));
	      }

	      return boundaryPieces;
	    }

	    function getCollisionDetector(state, liveIndex, deadIndex) {
	      return function () {
	        var livePiece = state.get('livePiece');
	        var boundaryPieces = state.get('deadPieces');
	        var gameSpec = state.get('gameSpec');
	        ...
	        var isHitting = boundaryPieces.reduce(function (deadAlreadyHit, deadSquare) {
	          var deadDetectedNewHit = livePiece.reduce(function (liveAlreadyHit, liveSquare) {
	            var liveCorner = [liveSquare.get('x') + liveIndex[0] * blockSize, liveSquare.get('y') + liveIndex[1] * blockSize];
	            var deadCorner = [deadSquare.get('x') + deadIndex[0] * blockSize, deadSquare.get('y') + deadIndex[1] * blockSize];

	            var xCoordsMatch = liveCorner[0] == deadCorner[0];
	            var yCoordsMatch = liveCorner[1] == deadCorner[1];

	            var liveDetectedNewHit = xCoordsMatch && yCoordsMatch;
	    ...
	    function doesOverlap(state, currentPiece) {
	      var deadPieces = state.get('deadPieces');
	      var gameSpec = state.get('gameSpec');

	      var boundaryPieces = getBoundaries(deadPieces, gameSpec);

	      var foundHit = boundaryPieces.reduce(function (boundaryAlreadyOverlaps, boundaryPiece) {
	        var currentPieceFoundHit = currentPiece.reduce(function (pieceAlreadyOverlaps, square) {
	          var currentlyHitting = boundaryPiece.get('x') == square.get('x') && boundaryPiece.get('y') == square.get('y');
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot not apply hot update to " + "collisionLogic.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "collisionLogic.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */if (false) {
	  ...
	  (function () {
	    ...
	    exports.attemptCollapse = attemptCollapse;
	    exports.getPieceCreator = getPieceCreator;
	    exports.makeQueuedPieceLive = makeQueuedPieceLive;
	    exports.queueNewPiece = queueNewPiece;
	    exports.createLivePiece = createLivePiece;
	    exports.lockLivePiece = lockLivePiece;

	    var _immutable = __webpack_require__(162);

	    var Immutable = _interopRequireWildcard(_immutable);

	    var _pieceCreators = __webpack_require__(166);
	    ...
	    function deleteRowFromState(state, row) {
	      ...
	      var _loop = function _loop() {
	        ...
	        var squareIndex = deadPieces.findIndex(function (deadBlock) {
	          return deadBlock.get('x') == square.get('x') && deadBlock.get('y') == square.get('y');
	        });

	        deadPieces = deadPieces.delete(squareIndex);
	        state = state.update('deadPieces', function () {
	          return deadPieces;
	        });
	      };
	    ...
	    function downshiftDeadBlocks(state, yIndex) {
	      ...
	      deadPieces = deadPieces.map(function (currentPiece) {
	        var currentY = currentPiece.get('y');
	        var isAbove = currentY < yIndex;
	        var shiftValue = isAbove ? blockSize : 0;

	        return currentPiece.update('y', function () {
	          return currentY + shiftValue;
	        });
	      });

	      return state.update('deadPieces', function () {
	        return deadPieces;
	      });
	    }

	    function attemptCollapse(state) {
	      var _state$get$toJS = state.get('gameSpec').toJS();

	      var widthRatio = _state$get$toJS.widthRatio;
	      var heightRatio = _state$get$toJS.heightRatio;
	      var blockSize = _state$get$toJS.blockSize;

	      var deadPieces = state.get('deadPieces');

	      var _loop2 = function _loop2(i) {
	        var yIndex = i * blockSize;

	        var deadPiecesInRow = deadPieces.filter(function (square) {
	    ...
	    function getPieceCreator(gameSpec) {
	      return function () {
	        var creators = [_pieceCreators.getIPiece, _pieceCreators.getLPiece, _pieceCreators.getTPiece, _pieceCreators.getOPiece, _pieceCreators.getSPiece, _pieceCreators.getZPiece, _pieceCreators.getJPiece];

	        var randomIndex = Math.floor(Math.random() * creators.length);

	        return creators[randomIndex](gameSpec);
	      };
	    }

	    function makeQueuedPieceLive(state) {
	      return state.update('livePiece', function () {
	        return state.get('queuedPiece');
	      });
	    }

	    function queueNewPiece(state) {
	      var getNewPiece = getPieceCreator(state.get('gameSpec'));

	      state = state.update('queuedPiece', function () {
	    ...
	    function createLivePiece(state) {
	      var getNewPiece = getPieceCreator(state.get('gameSpec'));
	    ...
	    function lockLivePiece(state) {
	      var livePiece = state.get('livePiece');
	      var deadPieces = state.get('deadPieces');

	      while (livePiece.size > 0) {
	        var squareToLock = livePiece.last();
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot not apply hot update to " + "gameflowLogic.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "gameflowLogic.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */if (false) {
	  ...
	  (function () {
	    ...
	    exports.getTPiece = getTPiece;
	    exports.getIPiece = getIPiece;
	    exports.getLPiece = getLPiece;
	    exports.getJPiece = getJPiece;
	    exports.getOPiece = getOPiece;
	    exports.getSPiece = getSPiece;
	    exports.getZPiece = getZPiece;
	    ...
	    function getTPiece(gameSpec) {
	      ...
	      var heightRatio = gameSpec.get('heightRatio');
	      var blockSize = gameSpec.get('blockSize');
	      var currentColor = (0, _helpers.getColor)();
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot not apply hot update to " + "pieceCreators.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "pieceCreators.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Provider = __webpack_require__(177);
	var connect = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isPlainObject = __webpack_require__(181);
	var wrapActionCreators = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */if (false) {
	  ...
	  (function () {
	    ...
	    function moveHorizontal(xShift) {
	      return {
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot not apply hot update to " + "actions.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TetrisContainer = exports.Tetris = undefined;
	...
	var Tetris = exports.Tetris = function (_React$Component) {
	  _inherits(Tetris, _React$Component);

	  function Tetris() {
	    _classCallCheck(this, Tetris);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Tetris).apply(this, arguments));
	  }
	  ...
	  _createClass(Tetris, [{
	    ...
	    value: function resetGame() {
	      this.pauseTimers();
	      this.props.dispatch((0, _actions.setInitialState)());
	    }
	  }, {
	    key: 'playTimers',
	    value: function playTimers() {
	      var _this2 = this;

	      window.descendInterval = window.setInterval(function () {
	        if (!_this2.props.gameLost) {
	          _this2.props.dispatch((0, _actions.descend)());
	        } else {
	      ...
	      window.timerInterval = window.setInterval(function () {
	        if (!_this2.props.gameLost) {
	          _this2.props.dispatch((0, _actions.incrementTime)());
	        } else {
	          window.clearInterval(window.timerInterval);
	        }
	      }, 1000);

	      this.props.dispatch((0, _actions.play)());
	    }
	  }, {
	    key: 'pauseTimers',
	    value: function pauseTimers() {
	      ...
	      this.props.dispatch((0, _actions.pause)());
	    }
	  }, {
	    ...
	    value: function componentWillMount() {
	      ...
	      document.onkeydown = function (e) {
	        if (e.keyCode === 40) {
	          // Down arrow
	          _this3.props.dispatch((0, _actions.descend)());
	        }
	        if (e.keyCode === 37) {
	          // Left arrow
	          _this3.props.dispatch((0, _actions.moveHorizontal)(-1));
	        }
	        if (e.keyCode === 39) {
	          // Right arrow
	          _this3.props.dispatch((0, _actions.moveHorizontal)(1));
	        ...
	        if (e.keyCode === 38) {
	          // Up arrow
	          _this3.props.dispatch((0, _actions.rotate)());
	        }
	      };
	    }
	  }, {
	...
	var TetrisContainer = exports.TetrisContainer = (0, _reactRedux.connect)(mapStateToProps)(Tetris);

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Tetris.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayingField = __webpack_require__(188);

	var _QueuedPiece = __webpack_require__(191);

	var _ControlPanel = __webpack_require__(192);
	  ...
	  _createClass(Game, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_PlayingField.PlayingField, {
	          gameSpec: gameSpec,
	          xOffset: 0,
	          yOffset: 0,
	          livePiece: this.props.livePiece,
	        ...
	        _react2.default.createElement(_QueuedPiece.QueuedPiece, {
	          gameSpec: gameSpec,
	          xOffset: widthRatio * blockSize,
	          yOffset: 0,
	          queuedPiece: this.props.queuedPiece
	        }),
	        _react2.default.createElement(_ControlPanel.ControlPanel, {
	          gameSpec: gameSpec,
	          xOffset: widthRatio * blockSize,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PlayingField = undefined;

	var _react = __webpack_require__(3);

	var _react2 = _interopRequireDefault(_react);

	var _LivePiece = __webpack_require__(189);

	var _DeadPieces = __webpack_require__(190);
	...
	var PlayingField = exports.PlayingField = function (_React$Component) {
	  _inherits(PlayingField, _React$Component);

	  function PlayingField() {
	    _classCallCheck(this, PlayingField);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PlayingField).apply(this, arguments));
	  }

	  _createClass(PlayingField, [{
	    key: 'render',
	    value: function render() {
	      var _props$gameSpec$toJS = this.props.gameSpec.toJS();

	      var widthRatio = _props$gameSpec$toJS.widthRatio;
	      var heightRatio = _props$gameSpec$toJS.heightRatio;
	      var blockSize = _props$gameSpec$toJS.blockSize;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_LivePiece.LivePiece, {
	          gameSpec: this.props.gameSpec,
	          livePiece: this.props.livePiece
	        }),
	        _react2.default.createElement(_DeadPieces.DeadPieces, {
	          gameSpec: this.props.gameSpec,
	          deadPieces: this.props.deadPieces
	        })
	      );
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PlayingField.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LivePiece = exports.LivePiece = function (_React$Component) {
	  _inherits(LivePiece, _React$Component);

	  function LivePiece() {
	    _classCallCheck(this, LivePiece);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(LivePiece).apply(this, arguments));
	  }

	  _createClass(LivePiece, [{
	    key: "getBlocks",
	    value: function getBlocks(pieces) {
	      var _props$gameSpec$toJS = this.props.gameSpec.toJS();

	      var blockSize = _props$gameSpec$toJS.blockSize;

	      var coordinatePairs = pieces.toJS();

	      var rects = coordinatePairs.map(function (c, index) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "g",
	        null,
	        this.getBlocks(this.props.livePiece)
	      );
	    }
	  }]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "LivePiece.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeadPieces = exports.DeadPieces = function (_React$Component) {
	  _inherits(DeadPieces, _React$Component);

	  function DeadPieces() {
	    _classCallCheck(this, DeadPieces);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(DeadPieces).apply(this, arguments));
	  }

	  _createClass(DeadPieces, [{
	    key: "getBlocks",
	    value: function getBlocks(pieces) {
	      var _props$gameSpec$toJS = this.props.gameSpec.toJS();
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "DeadPieces.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QueuedPiece = exports.QueuedPiece = function (_React$Component) {
	  _inherits(QueuedPiece, _React$Component);

	  function QueuedPiece() {
	    _classCallCheck(this, QueuedPiece);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QueuedPiece).apply(this, arguments));
	  }

	  _createClass(QueuedPiece, [{
	    key: 'getQueuedPiece',
	    value: function getQueuedPiece() {
	      var _this2 = this;

	      var gameSpec = this.props.gameSpec;
	      var blockSize = gameSpec.get('blockSize');
	      var queuedSquares = this.props.queuedPiece;

	      var rects = queuedSquares.map(function (c, index) {
	        return _react2.default.createElement('rect', {
	          x: c.get('x') + _this2.props.xOffset - 1.5 * blockSize,
	          y: c.get('y') + _this2.props.yOffset + 4 * blockSize,
	          width: blockSize,
	          height: blockSize,
	          fill: c.get('color'),
	          key: index
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "QueuedPiece.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayButton = __webpack_require__(195);

	var _ResetButton = __webpack_require__(196);
	  ...
	  _createClass(ControlPanel, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_PlayButton.PlayButton, {
	          gameSpec: this.props.gameSpec,
	          xOffset: this.props.xOffset,
	          yOffset: this.props.yOffset,
	          isPaused: this.props.isPaused,
	        ...
	        _react2.default.createElement(_ResetButton.ResetButton, {
	          gameSpec: this.props.gameSpec,
	          xOffset: this.props.xOffset,
	          yOffset: this.props.yOffset,
	          resetGame: this.props.resetGame,
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ControlPanel.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = exports.Timer = function (_React$Component) {
	  ...
	  _createClass(Timer, [{
	    key: 'formatTime',
	    value: function formatTime(secondsElapsed) {
	      var mins = Math.floor(secondsElapsed / 60);
	      var secs = secondsElapsed % 60;

	      var isMinSingleDigit = mins < 10;
	      var isSecSingleDigit = secs < 10;

	      var minString = isMinSingleDigit ? "0" + mins.toString() : mins.toString();
	      var secString = isSecSingleDigit ? "0" + secs.toString() : secs.toString();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayButton = exports.PlayButton = function (_React$Component) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/reactris/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PlayButton.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResetButton = exports.ResetButton = function (_React$Component) {
	  _inherits(ResetButton, _React$Component);

	  function ResetButton() {
	    _classCallCheck(this, ResetButton);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ResetButton).apply(this, arguments));
	  }
